...
> Origin [https://datatracker.ietf.org/doc/html/rfc7714](https://datatracker.ietf.org/doc/html/rfc7714)
...
- a 16-octet first_key_block, which is used in forming the authentication tag, and
...
```
   ...
   For the sake of clarity, we specify three additional parameters:
      ...
      Maximum number of invocations    SRTP: MUST be at most 2^48 for a given instantiation     SRTCP: MUST be at most 2^31
